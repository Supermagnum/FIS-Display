...
| 2 | BS170 N‑MOSFET (3LB level shift FET) | `BS170-ND` | 3 | TO‑92 THT | One per 3LB line (DATA, CLK, ENA) using NXP bidirectional MOSFET level shifter topology. **THT preferred** |
| 3 | 10 kΩ 1/4 W 5 % resistors (5 V pull‑ups for 3LB) | e.g. `CF14JT10K0CT-ND` | 3 | Axial THT resistor | 10 kΩ from each 3LB line (5 V side) to +5 V. **THT preferred** |
| 4 | 10 kΩ 1/4 W 5 % resistors (3.3 V pull‑ups for 3LB) | e.g. `CF14JT10K0CT-ND` | 3 | Axial THT resistor | 10 kΩ from each Pico‑side 3LB line to +3.3 V. **THT preferred** |
