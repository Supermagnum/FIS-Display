...
| 3 | 2.2 kΩ 1/4 W 5 % resistors (5 V pull‑ups for 3LB) | e.g. `CF14JT2K20CT-ND` (2.2 kΩ) | 6 | Axial THT resistor | 2.2 kΩ from each level‑shifter 5 V side node (ENA/CLK/DATA, RX+TX) to +5 V. Prefer metal film or SMD thick/thin film; avoid wirewound. **THT preferred** |
| 4 | 2.2 kΩ 1/4 W 5 % resistors (3.3 V pull‑ups for 3LB) | e.g. `CF14JT2K20CT-ND` (2.2 kΩ) | 6 | Axial THT resistor | 2.2 kΩ from each level‑shifter 3.3 V side node (ENA/CLK/DATA, RX+TX) to +3.3 V. Prefer metal film or SMD thick/thin film; avoid wirewound. **THT preferred** |
| 5 | 100 Ω 1/4 W 5 % resistors (series damping on 3LB outputs, optional) | e.g. `CF14JT100RCT-ND` | 3 | Axial THT resistor | In series between Pico/level‑shifter outputs and cluster T32a pins to reduce ringing and EMI. Prefer metal film or SMD thick/thin film; avoid wirewound. **THT preferred** |
...
| 17 | 1 kΩ 1/4 W 5 % resistor (LED series) | e.g. `CF14JT1K00CT-ND` | 1 | Axial THT resistor | Sets LED current to a few mA from 5 V; metal film or SMD thick/thin film recommended; avoid wirewound. **THT preferred** |
