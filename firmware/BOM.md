...
| 3 | 2.2 kΩ 1/4 W 5 % resistors (5 V pull‑ups for 3LB) | e.g. `CF14JT10K0CT-ND` | 6 | Axial THT resistor | 2.2 kΩ from each level‑shifter 5 V side node (ENA/CLK/DATA, RX+TX) to +5 V. Prefer metal film or SMD thick/thin film; avoid wirewound. **THT preferred** |
| 4 | 2.2 kΩ 1/4 W 5 % resistors (3.3 V pull‑ups for 3LB) | e.g. `CF14JT10K0CT-ND` | 6 | Axial THT resistor | 2.2 kΩ from each level‑shifter 3.3 V side node (ENA/CLK/DATA, RX+TX) to +3.3 V. Prefer metal film or SMD thick/thin film; avoid wirewound. **THT preferred** |
